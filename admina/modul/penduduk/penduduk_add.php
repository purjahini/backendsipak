...
<div class="row">
    <div class="col-lg-12"> 
        <div class="box box-solid box-primary">
                  ...
                  <div class="box-body">
                     <form id="input" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/penduduk/penduduk_action.php?act=in">
                      <div class="form-group">
                        <label for="nama_user" class="control-label col-lg-2">nama_user</label>
                        <div class="col-lg-10">
                          <input type="text" name="nama_user" placeholder="nama_user" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="nik_user" class="control-label col-lg-2">nik_user</label>
                        <div class="col-lg-10">
                          <input type="text" data-rule-number="true" name="nik_user" placeholder="nik_user" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
