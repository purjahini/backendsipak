                ...
                <section class="content-header">
                    <h1>
                     Surat Menikah
                        ...
                        <li class="active">Tambah Surat Menikah</li>
                    </ol>
                </section>
    ...
    <div class="col-lg-12"> 
        <div class="box box-solid box-primary">
                                 <div class="box-header">
                                    <h3 class="box-title">Tambah Surat Menikah</h3>
                  ...
                  <div class="box-body">
                     <form id="input" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/surat_menikah/surat_menikah_action.php?act=in">
                      <div class="form-group">
                        <label for="nama_pria" class="control-label col-lg-2">nama_pria</label>
                        <div class="col-lg-10">
                          <input type="text" name="nama_pria" placeholder="nama_pria" class="form-control" > 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="nik_pria" class="control-label col-lg-2">nik_pria</label>
                        <div class="col-lg-10">
                          <input type="text" name="nik_pria" placeholder="nik_pria" class="form-control" > 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="jenis_kel_pria" class="control-label col-lg-2">jenis_kel_pria</label>
                        <div class="col-lg-10">
                          <input type="text" name="jenis_kel_pria" placeholder="jenis_kel_pria" class="form-control" > 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="tempat_lahir_pria" class="control-label col-lg-2">tempat_lahir_pria</label>
                        <div class="col-lg-10">
                          <input type="text" name="tempat_lahir_pria" placeholder="tempat_lahir_pria" class="form-control" > 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="tanggal_lahir_pria" class="control-label col-lg-2">tanggal_lahir_pria</label>
                        <div class="col-lg-10">
                          <input type="text" name="tanggal_lahir_pria" placeholder="tanggal_lahir_pria" class="form-control" > 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="pekerjaan_pria" class="control-label col-lg-2">pekerjaan_pria</label>
                        <div class="col-lg-10">
                          <input type="text" name="pekerjaan_pria" placeholder="pekerjaan_pria" class="form-control" > 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="alamat_pria" class="control-label col-lg-2">alamat_pria</label>
                        <div class="col-lg-10">
                          <input type="text" name="alamat_pria" placeholder="alamat_pria" class="form-control" > 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="nama_wanita" class="control-label col-lg-2">nama_wanita</label>
                        <div class="col-lg-10">
                          <input type="text" name="nama_wanita" placeholder="nama_wanita" class="form-control" > 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="nik_wanita" class="control-label col-lg-2">nik_wanita</label>
                        <div class="col-lg-10">
                          <input type="text" name="nik_wanita" placeholder="nik_wanita" class="form-control" > 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="jenis_kel_wanita" class="control-label col-lg-2">jenis_kel_wanita</label>
                        <div class="col-lg-10">
                          <input type="text" name="jenis_kel_wanita" placeholder="jenis_kel_wanita" class="form-control" > 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="tempat_lahir_wanita" class="control-label col-lg-2">tempat_lahir_wanita</label>
                        <div class="col-lg-10">
                          <input type="text" name="tempat_lahir_wanita" placeholder="tempat_lahir_wanita" class="form-control" > 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="tanggal_lahir_wanita" class="control-label col-lg-2">tanggal_lahir_wanita</label>
                        <div class="col-lg-10">
                          <input type="text" name="tanggal_lahir_wanita" placeholder="tanggal_lahir_wanita" class="form-control" > 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="pekerjaan_wanita" class="control-label col-lg-2">pekerjaan_wanita</label>
                        <div class="col-lg-10">
                          <input type="text" name="pekerjaan_wanita" placeholder="pekerjaan_wanita" class="form-control" > 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="alamat_wanita" class="control-label col-lg-2">alamat_wanita</label>
                        <div class="col-lg-10">
                          <input type="text" name="alamat_wanita" placeholder="alamat_wanita" class="form-control" > 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
...
<div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input type="text" name="create_surat_nikah" placeholder="create_surat_nikah" class="form-control" > 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
