                ...
                <section class="content-header">
                   ...
                   <ol class="breadcrumb">
                        ...
                        <li class="active">Detail Surat Kartu Keluarga</li>
                    </ol>
                </section>
    ...
    <div class="col-lg-12">
        <div class="box box-solid box-primary">
                                   <div class="box-header">
                                    <h3 class="box-title">Detail Surat Kartu Keluarga</h3>
...
<div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input type="text" disabled="" value="<?=$data_edit->jenis_kelamin;?>" class="form-control">
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="tempat_lahir" class="control-label col-lg-2">tempat_lahir</label>
                        <div class="col-lg-10">
                          <input type="text" disabled="" value="<?=$data_edit->tempat_lahir;?>" class="form-control">
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="tanggal_lahir" class="control-label col-lg-2">tanggal_lahir</label>
                        <div class="col-lg-10">
                          <input type="text" disabled="" value="<?=$data_edit->tanggal_lahir;?>" class="form-control">
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
...
<div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input type="text" disabled="" value="<?=$data_edit->dusun;?>" class="form-control">
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="kelurahan" class="control-label col-lg-2">kelurahan</label>
                        <div class="col-lg-10">
                          <input type="text" disabled="" value="<?=$data_edit->kelurahan;?>" class="form-control">
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="kecamatan" class="control-label col-lg-2">kecamatan</label>
                        <div class="col-lg-10">
                          <input type="text" disabled="" value="<?=$data_edit->kecamatan;?>" class="form-control">
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="kabupaten" class="control-label col-lg-2">kabupaten</label>
                        <div class="col-lg-10">
                          <input type="text" disabled="" value="<?=$data_edit->kabupaten;?>" class="form-control">
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="provinsi" class="control-label col-lg-2">provinsi</label>
                        <div class="col-lg-10">
                          <input type="text" disabled="" value="<?=$data_edit->provinsi;?>" class="form-control">
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="status_nikah" class="control-label col-lg-2">status_nikah</label>
                        <div class="col-lg-10">
                          <input type="text" disabled="" value="<?=$data_edit->status_nikah;?>" class="form-control">
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="agama" class="control-label col-lg-2">agama</label>
                        <div class="col-lg-10">
                          <input type="text" disabled="" value="<?=$data_edit->agama;?>" class="form-control">
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="gol_darah" class="control-label col-lg-2">gol_darah</label>
                        <div class="col-lg-10">
                          <input type="text" disabled="" value="<?=$data_edit->gol_darah;?>" class="form-control">
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="warganegara" class="control-label col-lg-2">warganegara</label>
                        <div class="col-lg-10">
                          <input type="text" disabled="" value="<?=$data_edit->warganegara;?>" class="form-control">
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
...
<div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input type="text" disabled="" value="<?=$data_edit->tanggal_pengajuan;?>" class="form-control">
                        </div>
                      </div><!-- /.form-group -->

                   
                    </form>
                    <a href="<?=base_index();?>surat-kartu-keluarga" class="btn btn-success btn-flat"><i class="fa fa-step-backward"></i> Kembali</a>
