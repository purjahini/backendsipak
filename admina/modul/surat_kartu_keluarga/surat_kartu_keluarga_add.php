                ...
                <section class="content-header">
                    <h1>
                     Surat Kartu Keluarga
                        ...
                        <li class="active">Tambah Surat Kartu Keluarga</li>
                    </ol>
                </section>
    ...
    <div class="col-lg-12"> 
        <div class="box box-solid box-primary">
                                 <div class="box-header">
                                    <h3 class="box-title">Tambah Surat Kartu Keluarga</h3>
                  ...
                  <div class="box-body">
                     <form id="input" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/surat_kartu_keluarga/surat_kartu_keluarga_action.php?act=in">
...
<div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input type="text" name="tanggal_lahir" placeholder="tanggal_lahir" class="form-control" > 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
...
<div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input type="text" name="status_nikah" placeholder="status_nikah" class="form-control" > 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
...
<div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input type="text" name="gol_darah" placeholder="gol_darah" class="form-control" > 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="warganegara" class="control-label col-lg-2">warganegara</label>
                        <div class="col-lg-10">
                          <input type="text" name="warganegara" placeholder="warganegara" class="form-control" > 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
...
<div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input type="text" name="tanggal_pengajuan" placeholder="tanggal_pengajuan" class="form-control" > 
                        </div>
                      </div><!-- /.form-group -->
