                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Edit Surat Kartu Keluarga</li>
                    </ol>
                </section>
    ...
    <div class="col-lg-12">
        <div class="box box-solid box-primary">
                                   <div class="box-header">
                                    <h3 class="box-title">Edit Surat Kartu Keluarga</h3>
                  ...
                  <div class="box-body">
                     <form id="update" method="post" class="form-horizontal" action="<?=base_admin();?>modul/surat_kartu_keluarga/surat_kartu_keluarga_action.php?act=up">
...
<div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input type="text" name="warganegara" value="<?=$data_edit->warganegara;?>" class="form-control" > 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
...
<div class="form-group">
                      ...
                      <input type="hidden" name="id" value="<?=$data_edit->id_kartukeluarga;?>">
                      <div class="form-group">
